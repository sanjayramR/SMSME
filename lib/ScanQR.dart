...
class _ScanQRState extends State<ScanQR> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      curvedappBar(),
      body: Container(padding: EdgeInsets.only(left:20,right: 20,bottom:20),
              child: Column(
                  ...
                  child: Material(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                                Text("Spokeid : $spokesid",
                                style: TextStyle(fontSize: 18.0),
                                textAlign: TextAlign.center,),
                                SizedBox(
                                  height :5
                                ), 
                                Text("LastOnTime :$ontime",
                                style: TextStyle(fontSize: 18.0),
                                textAlign: TextAlign.center,),
                                SizedBox(
                                  height :5
                                ),
                                Text("LastOffTime : $offtime",
                                style: TextStyle(fontSize: 18.0),
                                textAlign: TextAlign.center,),
                                SizedBox(
                                  height :5
                                ),
                                Text("LastWorkedDate : $workeddate",
                                style: TextStyle(fontSize: 18.0),
                                textAlign: TextAlign.center,),
                                ],
                       ),
